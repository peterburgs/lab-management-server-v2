...
router.get("/", (req, res, next) => {
    requireRoles_1.default([types_1.ROLES.ADMIN], req, res, next, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        try {
            const systemlogs = yield Request_1.default.find(Object.assign({ isHidden: false }, req.query)).exec();
            if (systemlogs.length) {
                log_1.default(statuses_1.STATUSES.SUCCESS, "Get all systemlogs successfully");
                res.status(200).json({
                    message: log_1.message(statuses_1.STATUSES.SUCCESS, "Get all systemlogs successfully"),
                    count: systemlogs.length,
                    systemlogs,
                });
            }
            else {
                log_1.default(statuses_1.STATUSES.ERROR, "Cannot get systemlogs");
                res.status(404).json({
                    message: log_1.message(statuses_1.STATUSES.ERROR, "Cannot get systemlogs"),
                    count: 0,
                    systemlogs: [],
                });
            }
...
router.post("/", (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    requireRoles_1.default([types_1.ROLES.LECTURER], req, res, next, (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
        let systemlog = new Systemlog_1.default({
            lab: req.body.lab,
        ...
        try {
            systemlog = yield systemlog.save();
            if (systemlog) {
                res.status(201).json({
                    message: log_1.message(statuses_1.STATUSES.CREATED, "Create new systemlog successfully"),
                    systemlog,
                });
            }
        }
